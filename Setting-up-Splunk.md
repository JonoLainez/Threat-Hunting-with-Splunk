...
## **Objective**  
The objective of this task is to **install and configure Splunk on an Ubuntu machine**. By completing this task, I will have Splunk up and running to collect and analyze security logs.
...
## Conclusion
 ...
 "Once Splunk is running, continue to the main threat hunting lab using the BOTSv3 dataset → https://github.com/JonoLainez/Threat-Hunting-with-Splunk"


<img width="1339" height="946" alt="image" src="https://github.com/user-attachments/assets/8683c2b1-80f3-42e4-a4df-b31771212ef9" />
